...
from .trainer_bert import TrainingArgs
...
class TrainerTextAudio:
    ...
    def validate(self):
        ...
        for _, batch in enumerate(tqdm(self.val_data)):
            ...
            with torch.no_grad():        
                output= self.model(b_audio_input, b_input_ids, b_input_mask, labels=b_labels)
